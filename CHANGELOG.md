...
## [0.1.2-beta] - 2026-05-15

<!-- release:publish -->

### Changes

- **应用内更新（Windows）**：下载远程 Release 时显示实际下载进度（精确到小数点后两位）；下载完成后自动替换本地程序并重启，重启后弹出更新成功提示。
- **测试版渠道**：本版本为预发布（beta）；在设置 → 更新中选择「测试版」渠道可查看并获取含预发布的 Release。
